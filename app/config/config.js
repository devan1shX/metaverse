...
const Config = {
  ...
  db: {
    ...
    database: process.env.DATABASE || 'metaverse',
  },
  USER_LEVELS:{
    ADMIN: "admin",
  ...
  skipCleaner: process.env.SKIP_CLEANER === 'true' || process.env.SKIP_CLEANER === true,
}
...
console.log('Configuration loaded:', {
  ...
  skipCleaner: Config.skipCleaner,
  SKIP_CLEANER_env: process.env.SKIP_CLEANER
});
